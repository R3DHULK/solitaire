...
class SolitareGameWindow(tk.Tk):
    def __init__(self, **kwargs):
        ...
        self.title("Solitaire by Sumalya Chatterjee")
...
class SolitareGameFrame(tk.Frame):
    ...
    def load_settings(self, ignore_scaled_cards_prefix=False):
        ...
        elif self.gamemode == "Solitaire Classic":
...
class Settings(tk.Toplevel):
    def __init__(self, parent, **kwargs):
        ...
        self.gametype_chooser_options = [
            "Solitaire Classic", "Vegas", "Practice Mode", "Custom"]
    ...
    def create_widgets(self):
        ...
        self.intro_label = tk.Label(self, text="Made by R3DHULK \n Solitaire Settings", font=(
    ...
    def reset_all(self):
        ...
        self.gametype_chooser_var.set("Solitaire Classic")
